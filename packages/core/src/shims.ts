...
interface BaseProps {
  ...
  /** 手指触摸后马上离开 */
  onTap?: Hook<(e: WechatMiniprogram.CustomEvent) => void>
  /** 手指触摸后，超过350ms再离开，如果指定了事件回调函数并触发了这个事件，tap事件将不被触发 */
  onLongpress?: Hook<(e: WechatMiniprogram.CustomEvent) => void>
  /** 手指触摸后，超过350ms再离开（推荐使用longpress事件代替） */
  onLongtap?: Hook<(e: WechatMiniprogram.CustomEvent) => void>
